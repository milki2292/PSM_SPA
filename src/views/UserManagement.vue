<template>
    <div>
        ...
        <h4>Zmien email</h4>
        <input type="textfield" id="newEmail" placeholder="New Email" />
        <button @click="changeEmail" id="emailBtn" class="btn btn-login btn-lg btn-block">Zmien</button>

        <h4>Zmien hasło</h4>
        <input type="textfield" id="newPass" placeholder="New Password" />
        <button @click="changePassword" id="passBtn" class="btn btn-login btn-lg btn-block">Zmien</button>

        <br>
        <br>
        <br>
        <br>
        <input type="textfield" id="confirmPassEmail" placeholder="Password" hidden />
        <button @click="changeEmailReauthenticate" id="confirmPassEmailBtn" class="btn btn-login btn-lg btn-block" hidden>Zatwierdź</button>

        <input type="textfield" id="confirmPassPass" placeholder="Password" hidden />
        <button @click="changePasswordReauthenticate" id="confirmPassPassBtn" class="btn btn-login btn-lg btn-block" hidden>Zatwierdź</button>
    </div>
</template>
